...
## OBD BLE Scan and Meme Playback Controls

After connecting, use **Enable OBD BLE Scan** or **Disable OBD BLE Scan** to
control the left eye's OBD/canbus scan. **Start/Stop Meme List Playback** cycles
all installed memes sequentially or returns to normal meme selection.
